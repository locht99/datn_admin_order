<template>
    ...
    <div class="bg-[#f9f9f9] mx-auto">
        <div class="container h-screen mx-auto grid grid-cols-[230px,_1fr] bg-[#f9f9f9] overflow-hidden">
            <aside class=" fixed w-[230px] bg-gradient-to-br from-[#e93c3b] to-[#f26435] h-full p-5 relative ">
