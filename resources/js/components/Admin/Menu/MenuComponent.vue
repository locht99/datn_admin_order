        ...
        <nav class="h-[100vh]">
            <ul>
                <li
                    ...
                    class="text-white my-2 py-2 pl-5 rounded-[10px]"
                >
                ...
                <li class="text-white my-2 py-2 pl-5 rounded-[10px]">
                    <router-link v-if="role == 1" to="/user" class="text-white">
                ...
                >
                    <li class="mb-2" v-if="role == 1">
                        <router-link to="/config-payment"
                            >Thông tin thanh toán</router-link
                        >
                    </li>
                    <li class="mb-2">
                        <router-link to="/settings"
                            >Thiết lập cửa hàng</router-link
                        >
                    </li>
                </Dropdown>
            </ul>
