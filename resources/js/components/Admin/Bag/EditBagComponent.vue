    ...
    <div class="packet-add my-4 grid grid-cols-6 gap-4">
        <div class="col-span-2 text-gray-600">
            ...
            <form @submit="formSubmit($event)">
                <div
                    class="bg-white rounded-md mt-4 p-4"
                ...
                >
                    <div class="grid grid-cols-12 mb-4">
                        ...
                        <p
                            ...
                            class="text-red-600 col-span-12 text-right"
                        >
                    ...
                    <div class="grid grid-cols-12 mb-4">
                        ...
                        <p
                            v-if="errors.weight_from_volume"
                            class="text-red-600 col-span-12 text-right"
                        >
                    ...
                    <div class="grid grid-cols-12 mb-4">
                        ...
                        <p
                            v-if="errors.wood_packing_price"
                            class="text-red-600 col-span-12 text-right"
                        >
                    ...
                    <div class="grid grid-cols-12 mb-4">
                        ...
                        <div class="flex col-span-7">
                            <span class="font-bold text-[16px]">{{data.description_sub_status}}</span>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 mb-4">
                        <div class="col-span-5 flex items-center">
        ...
        <div class="col-span-4">
            <i class="block pb-1 text-red-600 warning" v-if="!data.warehouse_id"
                >Chọn kho trước khi thêm đơn hàng...</i
            >
            <form @submit="formSearch($event)" class="form-search-code" v-else>
                    ...
                    <table class="w-full text-sm text-left dark:text-gray-400">
                        <thead class="text-sm text-white">
                            <tr>
                                <th
                                    scope="col"
                                    class="sticky top-0 bg-red-500 px-2 py-2"
                                >
                                    #
                                </th>
                                <th
                                ...
                                <th
                                    scope="col"
                                    class="sticky top-0 bg-red-500 px-2 py-2 w-10"
                                >
                                    &nbsp;
                                </th>
                                <th
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td
                                    class="px-2 py-2 text-center hover:text-red-800 cursor-pointer"
                                    :class="[
                                        item.order_id
                                            ? 'text-gray-600'
                                            : 'text-red-600',
...
export default {
                ...
                .then((res) => {
                    ...
                    .then((res) => {
                        ...
                        this.data["delivery_status"] =
                            ...
                            this.data["delivery_status"] = this.data["delivery_status"].charAt(0).toUpperCase() + this.data["delivery_status"].slice(1);
                            
                            this.data["description_sub_status"] =
    ...
    created() {
        ...
        if (this.id) {
            this.getAdminPacketData(this.id);
        }
    },
};
</script>
