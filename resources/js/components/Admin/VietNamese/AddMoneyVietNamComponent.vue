    ...
    >
        ...
        <div class="relative w-auto my-6 mx-auto max-w-6xl">
            ...
            >
                ...
                >
                    <h3 class="text-3xl font-semibold">Nạp tiền, điều chỉnh</h3>
                    <button
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <div>
                                        ...
                                        ><select
                                            name="admin_transactions[type_id]"
                                            v-model="data.type"
                                        ...
                                        >
                                            ...
                                            <option
                                                v-for="item in TypesTransaction"
                                                :value="item.id"
                                                :key="item.id"
                                            >
                                                {{ item.name }}
                                    ...
                                    <div>
                                        ...
                                        ><input
                                            name="admin_transactions_point"
                                            v-model="data.point_vn"
                                            type="text"
                                            class="w-full border-gray-300 rounded my-2 px-2 py-1"
                                        />
                                    </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        ><textarea
                                            name="admin_transactions[content]"
...
export default {
    ...
    methods: {
        ...
        GetTypeTransaction() {
            axios
                .get("http://127.0.0.1:8000/api/vietnamese-type-transaction")
                .then((response) => {
                    this.TypesTransaction =
                        response.data.admin_type_transactions_vietnamese;
                });
        },
    },
};
