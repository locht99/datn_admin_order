<template>
    <div class="pt-6">
        ...
        <div class="title grid grid-cols-2">
            ...
            <div class="col-sm-6">
                <div date-rangepicker class="flex items-center float-right">
                    ...
                    <button
                        @click="getReport"
                        class="bg-[#E93B3B] hover:bg-orange-800 duration-300 text-white p-2.5 mx-4 rounded-lg"
                    >
                        Save
                    </button>
                </div>
        ...
        <div class="grid grid-cols-2 gap-12 mb-12 mx-auto">
            ...
            <div class="grid grid-cols-3 place-items-center mx-auto gap-12">
                <div class="text-center">
                    ...
                    <p class="text-yellow-600 pt-2">Tổng số đơn hàng</p>
                </div>
                <div class="text-center">
                    <div>
                        <font-awesome-icon
                    ...
                    <p class="text-blue-600 pt-4 text-xl">
                        {{ formatPrice(total_deposite) }}
                    </p>
                    <p class="text-green-600 pt-2">
                        Tổng tiền đã đặt cọc đơn hàng
                    </p>
                </div>
                <div class="text-center">
                    <div>
                    ...
                    <p class="text-blue-600 pt-2">Tổng doanh thu tạm tính</p>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-12 mb-12 mx-auto">
                ...
                .then((res) => {
                    if (res.status == 200) {
                        ...
                        this.chartDataRevenue = {
                            labels: res.data.labelsRevenue,
                            datasets: [
                                {
                                    label: "Doanh thu ước tính theo ngày",
                                    data: res.data.dataRevenue,
