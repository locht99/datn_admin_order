<template>
   ...
   <div class="bg-gradient-to-br	from-[#e93c3b] to-[#f26435]   h-screen ">
    <div class="container mx-auto ">
        <form class=" bg-white w-[1100px] h-[593px] mx-auto translate-y-[70px] rounded-[10px] grid grid-cols-[1fr,_1fr]">
            ...
            <div class="main m-auto text-center h-[490px]">
                ...
                <div class="input relative">
                    ...
                    <input class="w-[315px] h-[50px] rounded-[5px] my-5 font-bold font-[19px] pl-[50px]" type="text"
                        placeholder="Tên đăng nhập..." v-model="name" /> <br />
